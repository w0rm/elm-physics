module AltPhysics.Solver exposing (solve)
...
import AltPhysics.SolverBody as SolverBody exposing (SolverBody)
import AltPhysics.SolverEquation as SolverEquation exposing (SolverEquation)
